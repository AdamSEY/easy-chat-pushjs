...
const publish = user.pushNotification('gender', {message: "Hello world!"}); // everyone in 'gender'
const publish2 = user.pushNotification(null, {test: true} , 'USER_ID'); // to a userID
